define(["underscore", "Backbone","jquery", "text!templates/detailBookTemplate.html","BookCollectionRest","BookModel"],
        function(_, Backbone,$, detailBookTemplate,BookCollection, BookModel) {
  var DetailBookView = Backbone.View.extend({
    ...
    render: function() {
        ...
        this.book = _.find(ltBooks.models,function(i) {return i.attributes.id==idBook;});
